        ...
        render() {
            ...
            return dataItem[editField] ? <td>
                ...
                <button className="k-button k-button-md k-rounded-md k-button-solid k-button-solid-base"
                        onClick={() => cancel(dataItem)}><span class="k-icon k-i-cancel-outline"></span>
                </button>
            </td> : <td>
                <DropDownButton themeColor="info" icon={'k-icon k-i-plus'} onItemClick={(event) => addChild(dataItem,event.item.id)}>
                    {issueType.map(value => <DropDownButtonItem imageUrl={value.icon} text={value.type} id={value.id}></DropDownButtonItem>)}
                </DropDownButton>
                <button className="k-button k-button-md k-rounded-md k-button-solid k-button-solid-base"
